...
public class DebitNoteModule extends config {
	...
	public void DebitNoteModule() throws InterruptedException {
		...
		assertEquals("BATCH IMPORT", driver.findElement(By.xpath(
				"(.//*[normalize-space(text()) and normalize-space(.)='Debit Note List'])[1]/following::button[1]"))
				.getText());
		assertEquals("NEW DEBIT NOTE", driver.findElement(By
		...
		assertEquals("Effective Date",
				driver.findElement(By.xpath(
						...
						.getText());
		assertEquals("Reference", driver.findElement(By
		...
		driver.findElement(By.xpath("//md-tab-item[2]")).click();
		Thread.sleep(2000);
		assertEquals("SN", driver.findElement(By.xpath(
	...
	public void DebitNote_NewDebitNote() throws InterruptedException {
		...
		assertEquals("Reference", driver.findElement(By.xpath(
				...
				.getText());
		assertEquals("Effective Date", driver.findElement(By.cssSelector(
				...
				.getText());
		assertEquals("Due Date", driver.findElement(By.cssSelector(
	...
	public void DebitNote_BatchImport_Page() throws InterruptedException {
		...
		sleep(8);
		assertEquals("Import your debit notes",
				driver.findElement(By
						.xpath("(.//*[normalize-space(text()) and normalize-space(.)='Collapse'])[1]/following::h2[1]"))
						.getText());
		assertEquals("Step 1.Download our debit notes template file", driver.findElement(By.xpath(
		...
		assertEquals(
				...
				driver.findElement(By.xpath(
						...
						.getText());
		assertEquals("Step 2.Copy your debit notes into the template", driver.findElement(By.xpath(
